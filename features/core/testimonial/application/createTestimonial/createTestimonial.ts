...
export class TestimonialCreate {
    ...
    async run(request: CreateTestimonialRequest): Promise<void> {
        ...
        const rating = new TestimonialRating(request.rating as TestimonialRatingEnum);
        ...
        const category = new TestimonialCategory(request.category as TestimonialCategoryEnum);
        ...
        const imageUrl = request.imageUrl ? new TestimonialImageUrl(request.imageUrl) : undefined;
        const videoUrl = request.videoUrl ? new TestimonialVideoUrl(request.videoUrl) : undefined;
